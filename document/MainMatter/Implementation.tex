...
Cada arista del DAG se inicializa con una probabilidad igual a todas sus aristas hermanas (i.e. todas las aristas que salen de su mismo nodo) tal que la suma de sus probabilidades sea 1. Un camino se escoge utilizando una variable uniforme donde su valor determina la arista a seleccionar.
...
\begin{itemize}
    ...
    \item La respuesta del algoritmo es el frente de rango $0$ de las mejores soluciones encontradas durante todo el ciclo de ejecuci\'on.
\end{itemize}
