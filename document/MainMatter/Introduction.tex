...
La entidad tambi\'en desarrolla otras l\'neas donde se estudia la posible mitigaci\'on de sesgos en flujos producidos por sistemas AutoML (\cite{consuegra2022intelligent}).
...
Integrar optimizaci\'on multobjetivo a los sistemas AutoML puede ser complicado porque los espacios de b\'usqueda  son ca\'oticos y no diferenciables. Es necesario poder integrar algoritmos evolucionarios multiobjetivo a sistemas de AutoML. % por ser agn\'osticos al espacio de decisi\'on y resistentes a cualquier forma del frente de Pareto.
