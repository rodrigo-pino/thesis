...
\begin{algorithm}[ht]
    \caption{AutoML Heter\'ogeneo Multiobjetivo}
...
\subsection{NSGA-II}
NSGA-II \brackcite{deb2002fast} es un algoritmo multiobjetvo basado en el frente de Pareto caracter\'isticos por dividir el proceso de selecci\'on de los individuos m\'as aptos en dos etapas:
\begin{itemize}
