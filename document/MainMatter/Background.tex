...
En el campo del Aprendizaje de M\'aquina Automatizado cuenta numerosas propuestas de distintos dominios: 
\begin{itemize}
...
Recientemente escalarizaci\'on ha encontrado uso en algoritmos gene\'eticos por descomposici\'on para optener muestras distintas del frente de pareto.  En \cite{paria2020flexible} se propone un algorimto capaz de muestrear un area determinada del frente de Pareto utilizando una estrategia basada en escalarizaci\'on aleatoria.
...
El algoritmo se beneficia de un humano en el proceso de optimizaci\'on que ayuda a gu\'iar la b\'usqueda utilizando restricciones interactivamente.
